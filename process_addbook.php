...
require('includes/config.php');
	...
	if(!empty($_POST))
	{
		...
		else
		{
			...
			$query="insert into book(b_own,b_nm,b_subcat,b_desc,b_edition,b_publisher,b_isbn,b_page,b_price,b_rent,b_img)
			values('$b_own','$b_nm','$b_cat','$b_desc','$b_edition','$b_publisher','$b_isbn',$b_pages,$b_price,$b_rent,'$b_img')";
