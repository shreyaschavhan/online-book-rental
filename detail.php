									...
									<div class="entry">
										<?php
													...
													<td width="50%" height="100%">
														<table border="0"  width="100%" height="100%">
															...
															<tr>
																...
																<td>: </td>
																<td align="left">
																<form id="add_to_cart_form" action="process_cart.php" method="get">'.
																	'<input type="hidden" name="nm" value='.$row['b_nm'] .'/>'.
																	'<input type="hidden" name="cat" value='.$_GET['cat'] .'/>'.
																	'<input type="hidden" name="rate" value='.$row['b_price'] .'/>'.
																	'<input type="hidden" name="rent" value='.$row['b_rent'] .'/>'.'.
																	<input type="radio"  value="Purchase Price" name="Price"><label> Buy</label>&nbsp;&nbsp;&nbsp;₹'.$row['b_price'].'
																	<input type="radio"  value="Rent Price" name="Price"><label> Rent </label>&nbsp;&nbsp;&nbsp;₹'.$row['b_rent'].'
																	<input type="radio"  value="Lend" name="Price"><label> Lend</label>&nbsp;&nbsp;&nbsp;₹0</td>
																</form>
															</tr>
														</table>
											...
											<table border="0" width="100%">
												 ...
												 {
													echo ' <td><a onclick="document.getElementById(\'add_to_cart_form\').submit();">
